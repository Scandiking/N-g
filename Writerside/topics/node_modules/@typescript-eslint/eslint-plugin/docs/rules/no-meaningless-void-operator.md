...
For example, it is recommended as one way of suppressing [`@typescript-eslint/no-floating-promises`](._no-floating-promises.md) instead of adding `.catch()` to a promise.
