...
> To enforce type definitions existing on call signatures, use [`explicit-function-return-type`](._explicit-function-return-type.md), or [`explicit-module-boundary-types`](._explicit-module-boundary-types.md).
