...
See [`no-misused-promises`](._no-misused-promises.md) for detecting code that provides Promises to _logical_ locations such as if statements.
:::
...
- [`no-misused-promises`](._no-misused-promises.md)
