...
See [settings](.._.._README.md#settings) for customization options for the resolution (i.e.
...
If you are using Webpack, see the section on [resolvers](.._.._README.md#resolvers).
...
To suppress errors from files that may not be properly resolved by your [resolver settings](.._.._README.md#resolver-plugins), you may add an `ignore` key with an array of `RegExp` pattern strings:
...
## Further Reading
 ...
 - [Resolver plugins](.._.._README.md#resolvers)
