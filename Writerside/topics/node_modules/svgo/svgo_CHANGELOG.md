...
* new plugin [convertTransform](convertTransform.js) (close [#5](https://github.com/svg/svgo/issues/5))
* new plugin [removeUnusedNS](removeUnusedNS.js)
...
* new plugin [convertPathData](convertPathData.js)
...
* new plugin [removeViewBox](removeViewBox.js)
* new plugin [cleanupEnableBackground](cleanupEnableBackground.js)
