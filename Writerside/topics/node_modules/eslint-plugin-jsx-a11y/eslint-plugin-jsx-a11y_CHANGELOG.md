...
1.5.0 / 2016-06-16
==================
- [new] Add [heading-has-content](heading-has-content.md) rule.
- [new] Add [html-has-lang](html-has-lang.md) rule.
- [new] Add [lang](lang.md) rule.
- [new] Add [no-marquee](docs/rules/no-marquee.md) rule.
- [new] Add [scope](scope.md) rule.
