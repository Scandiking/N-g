...
## Reference
 ...
 - [`patchFs`](api_patchFs.md) - rewrites Node's filesystem module `fs` with *fs-like* object `vol`
 - [`patchRequire`](api_patchRequire.md) - rewrites `require` function, patches Node's `module` module to use a given *fs-like* object for module loading
...
[Unlicense](fs-monkey_._LICENSE.) - public domain.
