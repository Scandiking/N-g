...
//        @ApiResponse(responseCode = "500", description = "Internal server error")
//    })
//    public ResponseEntity<RoomForPersonDTO> getRoomForPersonById(@PathVariable Long id) {
//        return ResponseEntity.ok(roomForPersonService.getRoomForPersonById(id));
//    }
//
//    //
...
//    //
//    @PostMapping
//    @Operation(summary="Create a new room for person", description = "Create a new room for person with the provided details")
...
//        @ApiResponse(responseCode = "500", description = "Internal server error")
//    })
//    public ResponseEntity<RoomForPersonDTO> updateRoomForPerson(@PathVariable Long id, @Valid @RequestBody RoomForPersonDTO roomForPersonDTO) {
//        return ResponseEntity.ok(roomForPersonService.updateRoomForPerson(id, roomForPersonDTO));
//    }
//
//    //
...
//        roomForPersonService.deleteRoomForPerson(id);
