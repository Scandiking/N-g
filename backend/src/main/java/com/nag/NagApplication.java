...
public class NagApplication implements CommandLineRunner {
    ...
    public void run(String[] args) throws Exception {
        ...
        Person person1 = new Person("4712345678", "John", "Smith", "josmi@mail.com", null, null);
        Person person2 = new Person("4787654321", "Kathy", "Carpenter", "kacarp@mail.com", null, null);
